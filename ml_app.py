...
def load_model(model_file):
    loaded_model = joblib.load(open(os.path.join('ml_models', model_file),"rb"))
    return loaded_model
...
def run_ml_app():
    ...
    # Load iris images:
    setosa = Image.open(os.path.join('iris_pictures', "i_setosa.jpg"))
    versicolor = Image.open(os.path.join('iris_pictures', "i_versicolor.jpg"))
    virginica = Image.open(os.path.join('iris_pictures', "i_virginica.jpg"))
